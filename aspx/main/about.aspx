...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	DataTable list_a = get_article_list("about",0,"");

	int adder_a__loop__id=0;
	foreach(DataRow adder_a in list_a.Rows)
	{
		adder_a__loop__id++;


	templateBuilder.Append("                                \r\n                                    <li class=\"");
	if ((Utils.ObjectToStr(adder_a["id"])==model.id.ToString()))
	{
	...
	templateBuilder.Append(linkurl("about",Utils.ObjectToStr(adder_a["id"])));

	templateBuilder.Append("' class=\"tr overflow\">" + Utils.ObjectToStr(adder_a["title"]) + "</a></li>\r\n                                    ");
	}	//end for if
