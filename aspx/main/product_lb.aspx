...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n\r\n    <div class=\"content\">\r\n        <div class=\"main-pad-7\">\r\n            <div class=\"main-pad-8\">\r\n                <div class=\"container-fluid\">\r\n                    <div class=\"row\">\r\n                        <div class=\"col-md-3\">\r\n                            <div class=\"subnav\">\r\n                                <div class=\"biaoti\"><span>产品中心</span></div>\r\n                                <ul class=\"list-unstyled clearfix\">\r\n                                    ");
	DataTable p_list = get_category_list("product",0);
	...
	int firstID = get_first_parent_id(category_id);

	templateBuilder.Append("\r\n                                    <li class=\"");
	if (firstID==Utils.StrToInt(Utils.ObjectToStr(p_adder["id"]), 0))
	{
	...
	templateBuilder.Append(linkurl("product_lb",Utils.ObjectToStr(p_adder["id"])));

	templateBuilder.Append("' class=\"tr overflow \">" + Utils.ObjectToStr(p_adder["title"]) + "</a></li>\r\n                                    ");
	}	//end for if
	...
	templateBuilder.Append("\r\n                            </div>\r\n                        </div>\r\n                        <div class=\"col-md-9\">\r\n                            <div class=\"title-5 clearfix hidden-xs hidden-sm\">\r\n                                <div class=\"biaoti pull-left\">产品展示</div>\r\n                            </div>\r\n                            <div class=\"picture-1\">\r\n                                <ul class=\"list-unstyled clearfix\">\r\n                                    ");
	DataTable list = get_article_list(channel, category_id, pagesize, page, "status=0", out totalcount, out pagelist, "product_lb", category_id,"__id__");

	foreach(DataRow acpabdr in list.Rows)
	{

	templateBuilder.Append("\r\n                                    <li class=\"pull-left\">\r\n                                        <div class=\"picture-1-list\">\r\n                                            <a href='");
	templateBuilder.Append(linkurl("product-show",Utils.ObjectToStr(acpabdr["id"])));

	templateBuilder.Append("'>\r\n                                                <div class=\"imgbox wow animate fadeIn\">\r\n                                                    <span class=\"tr3 sizeCover\" style=\"background-image: url(" + Utils.ObjectToStr(acpabdr["img_url"]) + ")\"></span>\r\n                                                </div>\r\n                                                <div class=\"textbox tr text-center overflow\">" + Utils.ObjectToStr(acpabdr["title"]) + "</div>\r\n                                            </a>\r\n                                        </div>\r\n                                    </li>\r\n                                    ");
	}	//end for if
