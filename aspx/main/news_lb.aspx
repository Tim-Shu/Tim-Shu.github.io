...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	DataTable p_list = get_category_list("news",0);
	...
	templateBuilder.Append(linkurl("news_lb",Utils.ObjectToStr(p_adder["id"])));
	...
	DataTable list = get_article_list(channel, category_id, pagesize, page, "status=0", out totalcount, out pagelist, "news_lb", category_id,"__id__");

	foreach(DataRow acpabdr in list.Rows)
	{

	templateBuilder.Append("\r\n                                    <li>\r\n                                        <a href='");
	templateBuilder.Append(linkurl("news-show",Utils.ObjectToStr(acpabdr["id"])));

	templateBuilder.Append("' class=\"clearfix\">\r\n                                            <div class=\"mc pull-left tr overflow\">" + Utils.ObjectToStr(acpabdr["title"]) + "</div>\r\n                                            <div class=\"time pull-right text-right\">");	templateBuilder.Append(Utils.ObjectToDateTime(Utils.ObjectToStr(acpabdr["add_time"])).ToString("yyyy-MM-dd"));
