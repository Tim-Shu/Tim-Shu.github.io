<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="QJcms.Web.api.payment.wxnatpay.index" %>
...
#tips{ display:none; }
p span.tip-box{ margin:0 auto; display:inline-block; color:#71b83d; font-size:16px; padding-left:20px; background:url(../../../lib/css/valid_icons.png) no-repeat -40px -20px;}
</style>
