<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tags_list.aspx.cs" Inherits="QJcms.Web.admin.channel.tags_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="tags_edit.aspx?action=<%=QJEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td align="center"><a href="tags_edit.aspx?action=<%#QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
    </tr>
  </ItemTemplate>
  <FooterTemplate>
