<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="site_edit.aspx.cs" Inherits="QJcms.Web.admin.channel.site_edit" ValidateRequest="false" %>
...
<div class="tab-content">
  ...
  <dl runat="server" id="dlDefaultSite" visible="false">
    <dt>是否默认</dt>
    <dd>
  ...
  <dl runat="server" id="dlMobileSite" visible="false">
    <dt>移动站点</dt>
    <dd>
      <div class="rule-single-checkbox">
...
<div class="tab-content" style="display:none;">
  ...
  <dl>
    <dt>投诉电话</dt>
    <dd>
      <asp:TextBox ID="txtHotline" runat="server" CssClass="input normal" />
      <span class="Validform_checktip">*非必填，区号+电话号码</span>
    </dd>
  </dl>
  <dl>
    <dt>QQ</dt>
    <dd>
      <asp:TextBox ID="txtQQ" runat="server" CssClass="input normal" />
  ...
  <dl>
    <dt>联系人</dt>
    <dd>
      <asp:TextBox ID="txtContact" runat="server" CssClass="input normal" />
    </dd>
  </dl>
  <dl>
    <dt>网站备案号</dt>
