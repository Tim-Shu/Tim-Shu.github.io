<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="brand_list.aspx.cs" Inherits="QJcms.Web.admin.channel.brand_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="brand_edit.aspx?action=<%=QJEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
          ...
          <li><asp:LinkButton ID="btnDelete" runat="server" CssClass="del" OnClientClick="return ExePostBack('btnDelete','删除后不可恢复，是否继续？');" onclick="btnDelete_Click"><i></i><span>删除</span></asp:LinkButton></li>
        </ul>        
        <div class="menu-list">
...
<div class="table-container">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
    <tr>
      ...
      <th width="18%" align="left">品牌LOGO</th>
  ...
  <ItemTemplate>
    <tr>
      ...
      <td><%#Eval("title")%></td>
      <td><%#string.IsNullOrEmpty(Eval("logo").ToString())?"暂未上传":"<img class=\"ltable-item-logo\" src=\""+Eval("logo")+"\" alt=\""+Eval("title")+"\" />"%></td>
      <td><%#new QJcms.BLL.channel_site().GetTitle(Convert.ToInt32(Eval("site_id")))%></td>
      ...
      <td align="center"><a href="brand_edit.aspx?action=<%#QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
    </tr>
  </ItemTemplate>
  <FooterTemplate>
