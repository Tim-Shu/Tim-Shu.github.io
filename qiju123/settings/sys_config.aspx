    ...
    <form id="form1" runat="server">
            ...
            <div class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        ...
                        <li runat="server" id="sys_sms_li" visible="false"><a href="javascript:;">短信平台设置</a></li>
                        <li runat="server" id="sys_mail_li" visible="false"><a href="javascript:;">邮件发送设置</a></li>
                        <li runat="server" id="sys_upload_li" visible="false" style="display: none;"><a href="javascript:;">文件上传设置</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="tab-content">
            ...
            <dl>
                <dt>经度X</dt>
                <dd>
                    <asp:TextBox ID="webqq2" runat="server" CssClass="input normal" />
                </dd>
            </dl>
            <dl>
                <dt>纬度Y</dt>
            ...
            <dl>
                <dt>QQ</dt>
                <dd>
                    <asp:TextBox ID="webqq1" runat="server" CssClass="input normal" />
                </dd>
            </dl>
            <dl>
                <dt>二维码</dt>
                <dd>
                    <asp:TextBox ID="webewm1" runat="server" CssClass="input normal upload-path" />
            ...
            <dl style="display: none;">
                <dt>二维码</dt>
                <dd>
                    <asp:TextBox ID="webewm2" runat="server" CssClass="input normal upload-path" />
                    <div class="upload-box upload-img">
                    </div>
                </dd>
            </dl>
        ...
        <!--手机短信设置-->
        <div class="tab-content" style="display: none" runat="server" id="sys_sms_div" visible="false">
            <dl>
                <dt>短信剩余数量</dt>
                <dd>
                    <asp:Label ID="labSmsCount" runat="server" />
                    <span class="Validform_checktip">尚未申请？<a href="http://sms.sms.cn/" target="_blank">请点击这里注册</a></span>
                </dd>
            </dl>
            <dl>
                <dt>短信API地址</dt>
            ...
            <dl>
                ...
                <dd>请不要使用系统默认账户test，因为它是公用的测试账号；<br />
                    ...
                    如果您尚未申请开通，<a href="http://sms.sms.cn/" target="_blank">请点击这里注册</a>成功后填写您的用户名和密码均可正常使用。
                </dd>
            </dl>
        </div>
        <!--/手机短信设置-->
        ...
        <!--邮件发送设置-->
        <div class="tab-content" style="display: none" runat="server" id="sys_mail_div" visible="false">
            <dl>
                <dt>SMTP服务器</dt>
                <dd>
        ...
        <!--上传配置-->
        <div class="tab-content" style="display: none" runat="server" id="sys_upload_div" visible="false">
            <dl>
                <dt>文件上传目录</dt>
                <dd>
            ...
            <div runat="server" id="sys_upload_attach" visible="false">
                <dl>
                    <dt>附件上传类型</dt>
                    <dd>
      ...
      <span class="Validform_checktip">*超过设定的文件大小不予上传，0不限制</span>
            ...
            <div runat="server" id="sys_upload_video" visible="false">
                <dl>
                    <dt>视频上传类型</dt>
                    <dd>
      ...
      <span class="Validform_checktip">*超过设定的文件大小不予上传，0不限制</span>
            ...
            <div runat="server" id="sys_upload_img" visible="false">
                <dl>
                    <dt>图片上传大小</dt>
                    <dd>
      ...
      <span class="Validform_checktip">*左边高度，右边宽度，超出自动裁剪，0为不受限制</span>
            ...
            <div runat="server" id="sys_upload_thumb" visible="false">
                <dl>
                    <dt>缩略图生成尺寸</dt>
                    <dd>
      ...
      <span class="Validform_checktip">*左边高度，右边宽度，0为不生成缩略图</span>
            ...
            <div runat="server" id="sys_upload_water" visible="false">
                <dl>
                    <dt>图片水印类型</dt>
                    <dd>
                        <div class="rule-multi-radio">
