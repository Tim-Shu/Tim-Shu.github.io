<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="advert_list.aspx.cs" Inherits="QJcms.Web.admin.plugins.advert_list" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="advert_edit.aspx?action=<%=QJEnums.ActionEnum.Add %>&aid=<%=this.aid %>"><i></i><span>新增</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td><a href="advert_edit.aspx?action=<%#QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
    ...
    <td align="center">
      <a href="advert_edit.aspx?action=<%#QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">编辑</a>
    </td>
  </tr>
</ItemTemplate>
<FooterTemplate>
