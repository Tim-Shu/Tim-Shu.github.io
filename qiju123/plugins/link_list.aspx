<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="link_list.aspx.cs" Inherits="QJcms.Web.admin.plugins.link_list" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><a href="link_edit.aspx?action=<%=QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%><%# Convert.ToInt32(Eval("is_lock")) == 1 ? "(未审核)" : ""%></a></td>
    <td><%#new QJcms.BLL.channel_site().GetTitle(Eval("site_path").ToString())%></td>
    ...
    <td align="center"><a href="link_edit.aspx?action=<%#QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
