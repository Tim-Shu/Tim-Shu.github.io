<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="script_code_list.aspx.cs" Inherits="QJcms.Web.admin.plugins.script_code_list" %>
    ...
    <div id="floatHead" class="toolbar-wrap">
      <div class="toolbar">
        <div class="box-wrap">
          ...
          <div class="l-list">
            <ul class="icon-list">
              <li runat="server" id="tool_add"><a class="add" href="script_code_edit.aspx?action=<%=QJEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
              <li><a class="all" href="javascript:;" onclick="checkAll(this);"><i></i><span>全选</span></a></li>
              <li runat="server" id="tool_edit">
                <asp:LinkButton ID="btnSave" runat="server" CssClass="save" OnClick="btnSave_Click"><i></i><span>保存</span></asp:LinkButton></li>
              <li runat="server" id="tool_audit">
      ...
      <asp:Repeater ID="rptList" runat="server" OnItemCommand="rptList_ItemCommand">
        ...
        <ItemTemplate>
          <tr>
            ...
            <td><a href="script_code_edit.aspx?action=<%=QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%><%# Convert.ToInt32(Eval("is_lock")) == 1 ? "(未审核)" : ""%></a></td>
              <td><%#GetSiteTitle(Eval("site_id").ToString())%></td>
            ...
            <td align="center">
              <%#Convert.ToInt32(Eval("is_lock")) == 1 ? "×" : "√"%>
             
            </td>
            <td align="center"><a href="script_code_edit.aspx?action=<%#QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
          </tr>
        </ItemTemplate>
        <FooterTemplate>
