<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="feedback_reply.aspx.cs" Inherits="QJcms.Web.admin.plugins.feedback_reply" %>
...
<div class="tab-content">
  <dl>
    <dt>所属站点</dt>
    <dd><%=new QJcms.BLL.channel_site().GetTitle(model.site_path)%></dd>
  </dl>
  <dl>
    <dt>联系人</dt>
