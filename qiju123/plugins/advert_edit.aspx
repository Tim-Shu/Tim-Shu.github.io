<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="advert_edit.aspx.cs" Inherits="QJcms.Web.admin.plugins.advert_edit" ValidateRequest="false" %>
...
<head>
    ...
    <title>编辑广告内容</title>
    <link type="text/css" rel="stylesheet" href="../../lib/scripts/artdialog/ui-dialog.css" />
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#form1").initValidform();
            //初始化上传控件
            $(".upload-img").InitUploader({ sendurl: "../../tools/upload_ajax.ashx", swf: "../../lib/scripts/webuploader/uploader.swf", filetypes: "jpg,jpge,png,gif,<%=siteConfig.videoextension %>" });
        ...
        <div class="tab-content">
            ...
            <div runat="server" id="timeEffective" style="display: none;">
                <dl>
                    <dt>投放时间</dt>
                    <dd>
                        <asp:TextBox ID="txtStartTime" runat="server" CssClass="input rule-date-input" Text="1999-01-01" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" datatype="/^\d{4}\-\d{1,2}\-\d{1,2}$/" errormsg="请选择正确的日期" sucmsg=" " />
                ...
                <dl>
                    <dt>到期时间</dt>
                    <dd>
                        <asp:TextBox ID="txtEndTime" runat="server" CssClass="input rule-date-input" Text="2099-01-01" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" datatype="/^\d{4}\-\d{1,2}\-\d{1,2}$/" errormsg="请选择正确的日期" sucmsg=" " />
