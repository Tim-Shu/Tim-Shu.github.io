<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="picture_list.aspx.cs" Inherits="QJcms.Web.admin.weixin.picture_list" %>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center">
      <%#new QJcms.BLL.weixin_request_content().GetCount(Convert.ToInt32(Eval("id")))%> 条
    </td>
    <td align="center"><%#Convert.ToInt32(Eval("is_like_query")) == 1 ? "√" : "×"%></td>
    <td><%#string.Format("{0:g}", Eval("add_time"))%></td>
    <td align="center">
      <a href="picture_edit.aspx?action=<%#QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
    </td>
  </tr>
</ItemTemplate>
<FooterTemplate>
