<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="text_list.aspx.cs" Inherits="QJcms.Web.admin.weixin.text_list" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new QJcms.BLL.weixin_account().GetName()%></td>
    <td><%#Eval("keywords")%></td>
    <td><%#Utils.DropHTML( new QJcms.BLL.weixin_request_content().GetContent(Convert.ToInt32(Eval("id"))), 30)%></td>
    <td>
    ...
    <td align="center">
      <a href="text_edit.aspx?action=<%#QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
    </td>
  </tr>
</ItemTemplate>
<FooterTemplate>
