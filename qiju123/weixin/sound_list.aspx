<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sound_list.aspx.cs" Inherits="QJcms.Web.admin.weixin.sound_list" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#Eval("keywords")%></td>
    <td><%#new QJcms.BLL.weixin_request_content().GetContent(Convert.ToInt32(Eval("id")))%></td>
    <td>
    ...
    <td align="center">
      <a href="sound_edit.aspx?action=<%#QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
    </td>
  </tr>
</ItemTemplate>
<FooterTemplate>
