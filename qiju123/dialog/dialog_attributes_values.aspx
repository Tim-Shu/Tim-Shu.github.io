<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialog_attributes_values.aspx.cs" Inherits="QJcms.Web.admin.dialog.dialog_attributes_values" %>
  ...
  <script type="text/javascript">
    ...
    $(function () {
      ...
      $.ajax({
        ...
        data: { attr_id: api.data.attrId, attr_name: api.data.attrName },
        dataType: "json",
        ...
        success: function (data, textStatus) {
          if (data.status == 1) {
            ...
            $.each(data.rows, function () {
              ...
              var _category = $("<td>" + this.attr_name + "</td>").appendTo(_tr);
              ...
              var _edit = $("<a href=\"javascript:;\" class=\"edit\" id=\"" + this.id + "\" valName=\"" + this.name + "\" valSort=\"" + this.sort_id + "\">修改</a>").appendTo(_edit_td);
              //修改属性
              _edit.click(function () {
                var d = top.dialog({
                  ...
                  height: 135,
                  title: '修改属性值',
                  data: { attrId: api.data.attrId, attrName: api.data.attrName, doAjax: window, action: "edit", valId:this.id, valName: $(this).attr("valName"), valSort: $(this).attr("valSort") },
                  url: 'dialog/dialog_attributes_values_item.aspx'
                }).showModal();
              });
      ...
      $("a.add").click(function () {
        var d = top.dialog({
          ...
          height: 135,
          title: '添加属性值',
          data: { attrId: api.data.attrId, attrName: api.data.attrName, doAjax: window, action: "add" },
          url: 'dialog/dialog_attributes_values_item.aspx'
        }).showModal();
      });
      //删除选中
      $("a.del").click(function () {
        ...
        parent.dialog({
          ...
          okValue: '确定',
          ok: function () {
            sendAjax({ "id_list": _checkall }, "del_attributes_values");
          },
          cancelValue: '取消',
          cancel: function () { }
        }).showModal();
      ...
      $("a.save").click(function () {
        ...
        sendAjax({ "id_list": _p }, "save_attributes_values_sort");
      });
    });
    //判断是否有选中
      ...
      <div class="table-container">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
          <tr>
            ...
            <th align="left" width="25%">所属属性</th>
