...
<script type="text/javascript">
    ...
    $(function () {
        ...
        //初始化上传控年
        $(".upload-attach").InitUploader({ filesize: "<%=siteConfig.attachsize %>", sendurl: "../../tools/upload_ajax.ashx", swf: "../../lib/scripts/webuploader/uploader.swf", filetypes: "<%=siteConfig.fileextension %>" });
        //远程或者本地上传
