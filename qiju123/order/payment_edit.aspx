  ...
  <form id="form1" runat="server">
    ...
    <div class="tab-content">
      ...
      <dl>
        <dt>支付宝账号</dt>
        <dd>
          <asp:TextBox ID="txtAlipaymbSellerEmail" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
          <span class="Validform_checktip">*签约支付宝账号或卖家支付宝帐户</span>
        </dd>
      </dl>
      <dl>
        <dt>合作者身份(partner ID)</dt>
        <dd>
          <asp:TextBox ID="txtAlipaymbPartner" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
          <span class="Validform_checktip">*合作身份者ID，以2088开头由16位纯数字组成的字符串</span>
        </dd>
      </dl>
      <dl>
        <dt>交易安全校验码(key)</dt>
        <dd>
          <asp:TextBox ID="txtAlipaymbKey" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
          <span class="Validform_checktip">*交易安全检验码，由数字和字母组成的32位字符串</span>
        </dd>
      </dl>
      <%}
      ...
      <%}
          else if (model.api_path.ToLower().StartsWith("wxnatpay"))
          {%>
      <dl>
        <dt>微信商户号</dt>
        <dd>
          <asp:TextBox ID="txtWxnatPartner" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
      ...
      <dl>
        <dt>AppID(应用ID)</dt>
        <dd>
          <asp:TextBox ID="txtWxnatAppID" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
      ...
      <dl>
        <dt>支付密钥(key)</dt>
        <dd>
          <asp:TextBox ID="txtWxnatKey" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
          <span class="Validform_checktip">*商户支付密钥，进入微信支付【账户设置】【API安全】设置</span>
        </dd>
      </dl>
      <%}
          else if (model.api_path.ToLower().StartsWith("wxapipay"))
          {
      %>
      <dl>
        <dt>微信商户号</dt>
        <dd>
          <asp:TextBox ID="txtWxapiPartner" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
          <span class="Validform_checktip">*微信支付商户号</span>
        </dd>
      </dl>
      <dl>
        <dt>AppID(应用ID)</dt>
        <dd>
          <asp:TextBox ID="txtWxapiAppID" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
          <span class="Validform_checktip">*应用ID</span>
        </dd>
      </dl>
      <dl>
        <dt>支付密钥(key)</dt>
        <dd>
          <asp:TextBox ID="txtWxapiKey" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
          <span class="Validform_checktip">*商户支付密钥，进入微信支付【账户设置】【API安全】设置</span>
        </dd>
      </dl>
      <dl>
        ...
        <dd>
          <asp:TextBox ID="txtWxapiAppSecret" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
