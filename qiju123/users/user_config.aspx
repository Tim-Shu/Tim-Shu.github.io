...
<body class="mainbody">
  <form id="form1" runat="server">
      ...
      <div class="content-tab">
        <div class="content-tab-ul-wrap">
          <ul>
            ...
            <li><a href="javascript:;">注册协议</a></li>
            <li runat="server" id="user_point_li" visible="false"><a href="javascript:;">积分策略</a></li>
            <li runat="server" id="user_invited_li" visible="false"><a href="javascript:;">邀请码策略</a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <!--/注册协议-->
    <!--用户积分策略-->
    <div class="tab-content" style="display: none" runat="server" id="user_point_div" visible="false">
      <dl runat="server" id="getAmountPoint" visible="false">
        <dt>余额兑换积分比例</dt>
        <dd>
          <asp:TextBox ID="pointcashrate" runat="server" CssClass="input small" datatype="n" sucmsg=" " />个
      <span class="Validform_checktip">*1元账户余额兑换多少个积分，0为禁用兑换功能</span>
        </dd>
      </dl>
      <dl runat="server" id="getInvitedPoint" visible="false">
        <dt>邀请注册获得积分</dt>
        <dd>
    ...
    <!--/用户积分策略-->
    <!--用户邀请码策略-->
    <div class="tab-content" style="display: none" runat="server" id="user_invited_div" visible="false">
      <dl>
        <dt>邀请码使用期限</dt>
        <dd>
