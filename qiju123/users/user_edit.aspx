...
<div class="tab-content">
  <dl runat="server" id="dlGroup" visible="false">
    <dt>所属组别</dt>
    <dd>
  ...
  <dl runat="server" id="dlAvatar" visible="false">
    <dt>上传头像</dt>
    <dd>
...
<div class="tab-content" style="display:none;">
  <dl runat="server" id="dlAmount" visible="false">
    <dt>账户金额</dt>
    <dd>
  ...
  <dl runat="server" id="dlPoint" visible="false">
    <dt>账户积分</dt>
    <dd>
  ...
  <dl runat="server" id="dlLevel" visible="false">
    <dt>升级经验值</dt>
    <dd>
