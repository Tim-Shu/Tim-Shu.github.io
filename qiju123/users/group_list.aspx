...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="group_edit.aspx?action=<%=QJEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
  ...
  <asp:Repeater ID="rptList" runat="server">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
      ...
      <tr>
        ...
        <td>
          <a href="group_edit.aspx?action=<%#QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a>
        </td>
