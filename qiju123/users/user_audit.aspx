  ...
  <tr>
    ...
    <td>
      <div class="user-box" style="padding-left:0;">
        <h4><b><a href="user_edit.aspx?action=<%#QJEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("user_name")%></a></b> (昵称：<%#Eval("nick_name")%>)</h4>
        <i>注册时间：<%#string.Format("{0:g}",Eval("reg_time"))%></i>
      </div>
    </td>
    <td><%#new QJcms.BLL.user_groups().GetTitle(Convert.ToInt32(Eval("group_id")))%></td>
